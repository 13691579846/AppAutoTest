...
class Base(object):
    ...
    def find_elements(self, locator, timeout=30) -> list:
        ...
        try:
            ...
            print('no found elements {} by {}'.format(locator[1], locator[0]))
    ...
    def wait_element_presence(self, locator, timeout=30):
    ...
    def select_list_option(self, locator, option: int):
    ...
    def get_toast(self, text):
        ...
        """
        toast = self.wait_element_presence((MobileBy.XPATH, "//*[contains(@text, {})]".format(text)))
        return toast.text
